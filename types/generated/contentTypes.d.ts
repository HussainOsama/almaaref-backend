...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Events and programs offered by Almaaref';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
  ...
  attributes: {
    available_seats: Schema.Attribute.Integer & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOtpOtp extends Struct.CollectionTypeSchema {
  collectionName: 'otps';
  info: {
    description: 'One-time passcodes for phone login';
    displayName: 'OTP';
    pluralName: 'otps';
    singularName: 'otp';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['parent', 'student']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiParentParent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Parent account representing father or mother';
    displayName: 'Parent';
    pluralName: 'parents';
    singularName: 'parent';
  };
  ...
  attributes: {
    ...
    phone: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['father', 'mother']> &
      Schema.Attribute.Required;
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Payments linked to registrations and parents';
    displayName: 'Payment';
    pluralName: 'payments';
...
export interface ApiRegistrationRegistration
  ...
  info: {
    description: 'Event registration for a child with payment status';
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Independent student account';
    displayName: 'Student';
    pluralName: 'students';
